...
public class opj_image_comptparm extends Struct {
   ...
   */
  public final Unsigned32 dx = new Unsigned32();
  /** YRsiz: vertical separation of a sample of ith component with respect to the reference grid */
  public final Unsigned32 dy = new Unsigned32();
  /** data width */
  ...
  /** precision */
  public final Unsigned32 prec = new Unsigned32();
  /** image depth in bits */
  public final Unsigned32 bpp = new Unsigned32();
  /** signed (1) / unsigned (0) */
  public final Unsigned32 sgnd = new Unsigned32();
